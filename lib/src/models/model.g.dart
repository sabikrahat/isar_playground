...
const StudentSchema = CollectionSchema(
  ...
  indexes: {},
  links: {
    r'advisor': LinkSchema(
      id: 327113304557461571,
      name: r'advisor',
      target: r'Teacher',
      single: true,
    )
...
List<IsarLinkBase<dynamic>> _studentGetLinks(Student object) {
  return [object.advisor];
}

void _studentAttach(IsarCollection<dynamic> col, Id id, Student object) {
  object.id = id;
  object.advisor.attach(col, col.isar.collection<Teacher>(), r'advisor', id);
}
...
extension StudentQueryLinks
    on QueryBuilder<Student, Student, QFilterCondition> {
  QueryBuilder<Student, Student, QAfterFilterCondition> advisor(
      FilterQuery<Teacher> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'advisor');
    });
  }

  QueryBuilder<Student, Student, QAfterFilterCondition> advisorIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'advisor', 0, true, 0, true);
    });
  }
}
...
const DepartmentSchema = CollectionSchema(
  ...
  links: {
    r'teachers': LinkSchema(
      id: -5440994566138185764,
      name: r'teachers',
      target: r'Teacher',
      single: false,
    ),
    r'students': LinkSchema(
      id: 4736281104503204272,
      name: r'students',
      target: r'Student',
      single: false,
    )
...
void _departmentAttach(IsarCollection<dynamic> col, Id id, Department object) {
  object.id = id;
  object.teachers.attach(col, col.isar.collection<Teacher>(), r'teachers', id);
...
extension DepartmentQueryLinks
    on QueryBuilder<Department, Department, QFilterCondition> {
  QueryBuilder<Department, Department, QAfterFilterCondition> teachers(
      FilterQuery<Teacher> q) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Department, Department, QAfterFilterCondition> students(
